...
**For Line Following And Obstacle Avoidance** (remove Ultrasonic sensor for Line Follower only):
...
- [x] x1 Servo SG90 (for calculate the safest path to avoid obstacle) (optional)
...
- [Line Follower Robot - Arduino Project Hub](https://create.arduino.cc/projecthub/embeddedlab786/line-follower-robot-d22d06)
